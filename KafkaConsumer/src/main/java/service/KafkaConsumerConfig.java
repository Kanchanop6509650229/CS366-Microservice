...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Models> modelConsumerFactory() {
        ...
        JsonDeserializer<Models> deserializer = new JsonDeserializer<>(Models.class);
        deserializer.setRemoveTypeHeaders(true); // แก้ปัญหาการ Deserialize
        deserializer.addTrustedPackages("com.example.kafka", "service");
